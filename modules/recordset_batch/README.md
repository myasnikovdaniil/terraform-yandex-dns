...
| <a name="input_records"></a> [records](#input\_records) | List of managed records. Names can be specified with or without domain suffix. | <pre>list(object({<br/>      name = string<br/>      type = string<br/>      data = list(string) <br/>      ttl  = optional(string)<br/>  }))</pre> | n/a | yes |
